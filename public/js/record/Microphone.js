...
var getBlob = function(microphone) {
  var samples = microphone.samplesAll.subarray(0, microphone.samplesAllOffset);
  var dataview = microphone.encodeWav(samples, 1, microphone.audioContext.sampleRate);	
...
Microphone.prototype.stop = function() {
  ...
  this.onStopRecording(getBlob(this));
};
...
Microphone.prototype.playWav = function() {
  var url = window.URL.createObjectURL(getBlob(this));
  var audio = new Audio();
  audio.src = url;
  audio.play();
  //uploadFile(1, 'JOHN', audioBlob);
}

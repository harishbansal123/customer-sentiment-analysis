...
function initRecordButton(ctx) {
  ...
  recordButton.click((function() {
    ...
    return function(evt) {
      ...
      evt.preventDefault();
      var context = {};
      context.supportId = $('#supportAgent').val();
      context.supportName = $('#supportAgent :selected').text();
        
      console.log(context.supportId);
      console.log(context.supportName);
      ...
      if (!running) {
        ...
        handleMicrophone(token, null, mic, context, function(err) {
          if (err) {
